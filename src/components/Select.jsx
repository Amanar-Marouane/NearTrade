...
const Select = ({ children, name, label, src }) => {
    return (
        <div className="w-full px-6 flex flex-col gap-1">
            ...
            <div className={`flex justify-center items-center border p-1`}>
                ...
                <select className="w-full p-2 placeholder:text-lg focus:ring-0 focus:outline-none focus:border-transparent" name={name} id={name}>
                    {children}
                </select>
            </div>
